...
module.exports.run = async (bot, message, args) => {
           ...
           cpuStat.usagePercent(function(err, percent, seconds) {
            ...
            .setTitle("*** PING ***")
            .setColor('RANDOM')
            .addField("• Zużycie Memory", `${(process.memoryUsage().heapUsed / 1024 / 1024).toFixed(2)} / ${(os.totalmem() / 1024 / 1024).toFixed(2)} MB`, true)
            .addField("• Uptime ", `${hours}h ${mins}m ${secs}s`, true) //`${duration}`, true)
